...
END
LOOP LoopIndex FROM -20 TO 20 STEP 1
    MouseAndKeyboard.MoveMouse X: varx + 20 Y: vary + LoopIndex RelativeTo: MouseAndKeyboard.PositionRelativeTo.ActiveWindow MovementStyle: MouseAndKeyboard.MovementStyle.Instant
    MouseAndKeyboard.SendMouseClick.Click ClickType: MouseAndKeyboard.MouseClickType.LeftClick MillisecondsDelay: 0
END
LOOP LoopIndex FROM -20 TO 20 STEP 1
    MouseAndKeyboard.MoveMouse X: varx - 20 Y: vary + LoopIndex RelativeTo: MouseAndKeyboard.PositionRelativeTo.ActiveWindow MovementStyle: MouseAndKeyboard.MovementStyle.Instant
